...
- Updated the development dependency `fast-uri` to 3.1.6 to fix four high-severity vulnerabilities.
...
- Stabilized hide-on-scroll browser coverage by waiting for the completed header transition instead of a fixed delay.

## [2.1.1] - 2026-08-27

### Fixed

- Aligned the footer status bar into dedicated session, site metadata, and design attribution regions; the branch now precedes the shell prompt.

## [2.1.0] - 2026-08-27

### Changed

- Made hide-on-scroll the default header behavior on desktop and mobile: the header hides while scrolling down and returns while scrolling up.

## [2.0.3] - 2026-08-27

### Changed

- Centered the footer attribution in the terminal status bar on desktop, while preserving a responsive in-flow layout on narrower screens.

## [2.0.2] - 2026-08-27

### Added

- Added a footer attribution for adenyrr and AI, with links to the source repository and npm package.
...
[2.0.2]: https://github.com/adenyrr/astro-sovereign-tty/releases/tag/v2.0.2
...
[3.0.1]: https://github.com/adenyrr/astro-sovereign-tty/releases/tag/v3.0.1
