...
describe('2.1.0 release contract', () => {
  it('aligns the package, changelog and documented release', () => {
    ...
    expect(changelog).toContain('## [2.1.0] - 2026-08-27');
    expect(readme).toContain('Current release: `v2.1.0`');
    expect(readme).toContain(
      'src="https://raw.githubusercontent.com/adenyrr/astro-sovereign-tty/v2.1.0/preview.svg"',
    );
