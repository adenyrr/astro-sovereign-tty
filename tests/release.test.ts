...
describe('2.0.1 release contract', () => {
  it('aligns the package, changelog and documented release', () => {
    ...
    expect(changelog).toContain('## [2.0.1] - 2026-08-27');
    expect(readme).toContain('Current release: `v2.0.1`');
    expect(readme).toContain(
      'src="https://raw.githubusercontent.com/adenyrr/astro-sovereign-tty/v2.0.1/preview.svg"',
    );
